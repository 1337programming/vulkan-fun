...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #888
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #896
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #906
std::string vk_print_vkallocationcallbacks(const VkAllocationCallbacks* pStruct, const std::string prefix)
{
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #912
    ...
    stringstream ss[6];
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1069
    if (StreamControl::writeAddress)
        ss[0] << "0x" << pStruct->pUserData;
    else
        ss[0].str("address");
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1085
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1112
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #912
    ...
    stringstream ss[3];
    string stp_strs[1];
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1011
    if (pStruct->pNext) {
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1015
        tmp_str = dynamic_display((void*)pStruct->pNext, prefix);
        ss[0] << "0x" << &pStruct->pNext;
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1030
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1069
    if (StreamControl::writeAddress)
        ...
        ss[0].str("address");
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1075
    if (pStruct->pApplicationName != NULL) {
        ss[1] << pStruct->pApplicationName;
     } else {
        ss[1] << "";
     }
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1092: NB Edit this section to choose hex vs dec output by variable name
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1030
        ...
        stp_strs[0] = "";
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #931
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #933
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #938
        stp_strs[1] = "";
        ...
        if (pStruct->pWaitSemaphores) {
            for (uint32_t i = 0; i < pStruct->waitSemaphoreCount; i++) {
                index_ss.str("");
                index_ss << i;
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #989
                ss[1] << "0x" << pStruct->pWaitSemaphores[i];
                stp_strs[1] += " " + prefix + "pWaitSemaphores[" + index_ss.str() + "].handle = " + ss[1].str() + "\n";
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #999
                ss[1].str("");
            }
        }
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #931
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #938
        ...
        if (pStruct->pBufferBinds) {
            for (uint32_t i = 0; i < pStruct->bufferBindCount; i++) {
                index_ss.str("");
                index_ss << i;
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #979
                ss[2] << "0x" << &pStruct->pBufferBinds[i];
                tmp_str = vk_print_vksparsebuffermemorybindinfo(&pStruct->pBufferBinds[i], extra_indent);
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #986
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1060
    ss[2] << "0x" << (void*)pStruct->pWaitSemaphores;
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1089: NB: Edit here to choose hex vs dec output by variable name
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #912
    ...
    stringstream ss[6];
    string stp_strs[3];
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1037
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1045
    ss[0].str("");
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1037
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1057
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #912
    ...
    string stp_strs[3];
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #931
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #936
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #938
    stp_strs[0] = "";
    stringstream index_ss;
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1023
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1063
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #938
        ...
        if (pStruct->pDynamicStates) {
            for (uint32_t i = 0; i < pStruct->dynamicStateCount; i++) {
                index_ss.str("");
                index_ss << i;
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #973
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1099
    if (pStruct->pDynamicStates)
...
#endif //VK_USE_PLATFORM_XLIB_KHR
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1121
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1130
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1140
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1147
std::string dynamic_display(const void* pStruct, const std::string prefix)
{
    using namespace std;
    ...
    switch (sType)
    {
        ...
        default:
        return string();
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/VulkanTools/vk_helper.py line #1173
    }
}