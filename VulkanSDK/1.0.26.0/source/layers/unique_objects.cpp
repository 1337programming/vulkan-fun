...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #749
...
{
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #883
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #842
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #980
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #980
    ...
    if (VK_SUCCESS == result) {
        std::lock_guard<std::mutex> lock(global_lock);
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #961
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #980
    ...
    if (VK_SUCCESS == result) {
        std::lock_guard<std::mutex> lock(global_lock);
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #951
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #883
    layer_data *my_map_data = get_my_data_ptr(get_dispatch_key(instance), layer_data_map);
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #980
    VkResult result = get_dispatch_table(unique_objects_instance_table_map, instance)->CreateXlibSurfaceKHR(instance, pCreateInfo, pAllocator, pSurface);
    if (VK_SUCCESS == result) {
        std::lock_guard<std::mutex> lock(global_lock);
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #961
        uint64_t unique_id = global_unique_id++;
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #883
    layer_data *my_map_data = get_my_data_ptr(get_dispatch_key(instance), layer_data_map);
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #980
    VkResult result = get_dispatch_table(unique_objects_instance_table_map, instance)->CreateWaylandSurfaceKHR(instance, pCreateInfo, pAllocator, pSurface);
    if (VK_SUCCESS == result) {
        std::lock_guard<std::mutex> lock(global_lock);
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #961
        uint64_t unique_id = global_unique_id++;
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #883
    layer_data *my_map_data = get_my_data_ptr(get_dispatch_key(instance), layer_data_map);
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #980
    VkResult result = get_dispatch_table(unique_objects_instance_table_map, instance)->CreateMirSurfaceKHR(instance, pCreateInfo, pAllocator, pSurface);
    if (VK_SUCCESS == result) {
        std::lock_guard<std::mutex> lock(global_lock);
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #961
        uint64_t unique_id = global_unique_id++;
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #468
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #502
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #550
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #590
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #590
static inline PFN_vkVoidFunction intercept_xcb_enabled_command(const char *name, VkInstance instance)
{
    VkLayerInstanceDispatchTable* pTable = get_dispatch_table(unique_objects_instance_table_map, instance);
    if (instanceExtMap.size() == 0 || !instanceExtMap[pTable].xcb_enabled)
        return nullptr;
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #590
static inline PFN_vkVoidFunction intercept_xlib_enabled_command(const char *name, VkInstance instance)
{
    VkLayerInstanceDispatchTable* pTable = get_dispatch_table(unique_objects_instance_table_map, instance);
    if (instanceExtMap.size() == 0 || !instanceExtMap[pTable].xlib_enabled)
        return nullptr;
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #590
static inline PFN_vkVoidFunction intercept_wayland_enabled_command(const char *name, VkInstance instance)
{
    VkLayerInstanceDispatchTable* pTable = get_dispatch_table(unique_objects_instance_table_map, instance);
    if (instanceExtMap.size() == 0 || !instanceExtMap[pTable].wayland_enabled)
        return nullptr;
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #590
static inline PFN_vkVoidFunction intercept_mir_enabled_command(const char *name, VkInstance instance)
{
    VkLayerInstanceDispatchTable* pTable = get_dispatch_table(unique_objects_instance_table_map, instance);
    if (instanceExtMap.size() == 0 || !instanceExtMap[pTable].mir_enabled)
        return nullptr;
...
VKAPI_ATTR PFN_vkVoidFunction VKAPI_CALL GetInstanceProcAddr(VkInstance instance, const char* funcName)
{
    ...
    addr = intercept_xcb_enabled_command(funcName, instance);
    if (addr)
        return addr;

    addr = intercept_xlib_enabled_command(funcName, instance);
    if (addr)
        return addr;

    addr = intercept_wayland_enabled_command(funcName, instance);
    if (addr)
        return addr;

    addr = intercept_mir_enabled_command(funcName, instance);
    if (addr)
        return addr;
...
// CODEGEN : file /var/lib/jenkins/workspace/Create-Linux-VulkanSDK/Vulkan-LoaderAndValidationLayers/vk-layer-generate.py line #382
